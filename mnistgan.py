...
for epoch in range(epochs):
    ...
    save_generator_image(generated_img, "mnistoutput/gen_img{epoch}.png")
...
print('DONE TRAINING')
torch.save(generator.state_dict(), 'mnistoutput/generator.pth')
...
imageio.mimsave('/graphganvol/mnistoutput/out.png', imgs)
...
plt.legend()
plt.savefig('mnistoutput/loss.png')
